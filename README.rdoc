...
By default the program comes with a database of over 10,000 random generated names that can be found {here}[link:/brunobasto/query-language/src/META-INF/data/random-names.csv].
